...
| `SUPABASE_PUBLISHABLE_KEY` | Supabase Dashboard → Settings → API | 1. Copy new key 2. Update `.env` / launcher 3. Rebuild dashboard |
...
# Copy new anon key → update SUPABASE_PUBLISHABLE_KEY
```
