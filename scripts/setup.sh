...
if [[ ! -f .env ]]; then
  ...
  echo "       DASHBOARD_URL and NEXT_PUBLIC_APP_URL — local URL first, public HTTPS callback base for production"
...
echo "  2. Run the production regular-local stack: ./scripts/start.sh"
echo ""
