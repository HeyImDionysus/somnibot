...
const paypalStep: WizardStep = {
  ...
  instructions: [
    ...
    '7. Subscribe the webhook to: `CHECKOUT.ORDER.APPROVED`, `PAYMENT.CAPTURE.COMPLETED`, `PAYMENT.CAPTURE.REFUNDED`, `PAYMENT.CAPTURE.REVERSED`, `BILLING.SUBSCRIPTION.ACTIVATED`, `BILLING.SUBSCRIPTION.CANCELLED`, `BILLING.SUBSCRIPTION.SUSPENDED`, `BILLING.SUBSCRIPTION.PAYMENT.FAILED`, `PAYMENT.SALE.COMPLETED`, `PAYMENT.SALE.REFUNDED`, and `PAYMENT.SALE.REVERSED`',
    ...
    '> Do not subscribe `BILLING.SUBSCRIPTION.EXPIRED` yet; SomniBot currently removes access through cancellation, suspension, failed payment, refund, reversal, and reconciliation paths.',
