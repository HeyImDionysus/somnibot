/**
 * Tests for ../features/crafting/crafting-manager.js — instantiation and lifecycle.
 */
...
vi.mock('../features/crafting/crafting-renderer.js', () => ({
  renderRecipeList: vi.fn(() => ({})),
  renderCraftResult: vi.fn(() => ({})),
}));
