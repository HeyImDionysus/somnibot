/**
 * Tests for ../features/farming/farming-manager.js — instantiation and lifecycle.
 */
...
vi.mock('../features/farming/farm-renderer.js', () => ({
  renderFarm: vi.fn(() => ({})),
  renderPlantResult: vi.fn(() => ({})),
  renderHarvestResult: vi.fn(() => ({})),
}));
