...
const authenticatedDashboardSpecs =
  /(?:channel-picker-accessibility|team-invitations|community-flow|commerce-onboarding|completed-project-licensing|licensing-product-overview|licensing-prompt-generator|shared-foundations)\.spec\.ts/;
