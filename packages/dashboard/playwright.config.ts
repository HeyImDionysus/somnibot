...
const authenticatedDashboardSpecs =
  /(?:channel-picker-accessibility|team-invitations|community-flow|commerce-onboarding|licensing-product-overview|licensing-prompt-generator|shared-foundations)\.spec\.ts/;
