...
export async function POST(req: NextRequest) {
  ...
  // Only once the action is really on the queue. (The response below reports
  // success either way — a pre-existing gap in this route — but the change
  // history must not claim a sweep was queued when the insert failed.)
  if (!queueError) {
