...
export const GuildConfigSchema = z.object({
  ...
  min_xp: z.number().int().min(1).max(100).default(15),
  max_xp: z.number().int().min(1).max(200).default(25),
...
export const AutomationSchema = z.object({
  ...
  scope_target_user_ids: z.array(snowflake).default([]),
  scope_target_channel_ids: z.array(snowflake).default([]),
  scope_exclude_user_ids: z.array(snowflake).default([]),
  scope_exclude_channel_ids: z.array(snowflake).default([]),
