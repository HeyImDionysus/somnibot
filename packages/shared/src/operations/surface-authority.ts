...
const SURFACE_AUTHORITY: Readonly<Record<SurfaceCapability, SurfaceAuthorityDefinition>> = {
  ...
  service_lifecycle: { capability: 'service_lifecycle', authority: 'launcher', allowedSources: ['launcher', 'dashboard'] },
  ...
  community_behavior: { capability: 'community_behavior', authority: 'discord', allowedSources: ['discord', 'dashboard'] },
  immediate_staff_action: { capability: 'immediate_staff_action', authority: 'discord', allowedSources: ['discord', 'dashboard'] },
