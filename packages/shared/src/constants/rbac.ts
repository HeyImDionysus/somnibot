...
export const ROUTE_PERMISSIONS: Record<string, DashboardPermission | null> = {
  ...
  '/economy/fishing': 'dashboard.manage_economy',
  '/economy/adventures': 'dashboard.manage_economy',
  '/economy/market': 'dashboard.manage_economy',
  '/economy/trivia': 'dashboard.manage_economy',
  '/economy/games': 'dashboard.manage_economy',
  '/polls': 'dashboard.manage_economy',
  '/economy/pets': 'dashboard.manage_economy',
  '/economy/quests': 'dashboard.manage_economy',
  '/economy/achievements': 'dashboard.manage_economy',
