...
export const TRIGGER_META: TriggerMeta[] = [
  ...
  { type: 'subscription.expired', label: 'Subscription Expired', description: 'When a subscription term ends and access is removed', icon: '⌛', variables: ['{user}', '{plan}'], hasChannel: false, hasUser: true },
